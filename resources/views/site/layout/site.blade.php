...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/11.6.13/sweetalert2.min.css')}}">
...
{{--                        <span class="count">2</span>--}}
    ...
    <div class="breadcrumb">
        <div class="container-content">
            <div class="content">
                <h1 class="page-title-breadcrumb">@yield('subTitle')</h1>
                <ul class="items">
                    <li>
        ...
        <div class="content-footer">
            <div class="right-section">
                ...
                <ul class="links">
                    ...
                    @else
                        <li>    <a target="_self" href="{{ route('login') }}" class="login-link">
