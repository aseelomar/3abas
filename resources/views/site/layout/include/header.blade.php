<div class="container-content">
    <div class="content-header">
        <div class="shopping-and-login">
            ...
            @if (Auth::user())
            <a target="_self" href="{{ route('profile') }}" class="login-link">
            ...
            @else
            <a target="_self" href="{{ route('login') }}" class="login-link">
            ...
            <div class="shopping-bag">
                <a target="_self"  href="{{route('site.cart.show')}}">
        ...
        <ul class="links">
            ...
            <li>
                <a target="_self" href="{{route('site.allCategory')}}">@lang('site.category') </a>
            </li>
        </ul>
        <div class="search-box-header">
            <div class="form-group-search">
                ...
                <form  action="{{route('site.product.searchProduct')}}" method="POST" id="form-main-search">
                    @csrf
        ...
        <h1 class="logo">
            <a target="_self" href="{{route('site.index')}}">
                <span>@lang('site.name_store_en')</span>
            </a>
        </h1>
    </div>
</div>
