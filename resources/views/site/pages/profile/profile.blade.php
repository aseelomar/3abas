        ...
        @if (Auth::user())
            <div class="profile-page">
                <div class="container-content">
                    <div class="profile-layout">
                        <aside>
                            ...
                            <ul class="links-aside">
                                <li>
                                    <a target="_self" href="{{route('profile')}}" class="active">
                                ...
                                <li>
                                    <a  target="_self" href="{{route('site.order.orderHistory')}}">
                                ...
                                <li>
                                    <a target="_self"  href="{{ route('site.product.favProduct') }}">
                    ...
                    <div style="background-color: rgb(25, 155, 84)"  class="alert alert-success">
                        {{ Session::get('success') }}
                    </div>
                @endif --}}
                            <form method="POST" id="myFormStore" action="{{ route('profile.edit') }}"
                                enctype="multipart/form-data">
                                @csrf

                                <div class="user-image-content">
                                    <div class="img-box">
                                        <img src="{{ $user->image  }}" id="user_image" alt="img" />
                                    </div>
...
<script type="text/javascript">
    ...
    var latX = '{{ @$user->latitude?? '34.09624440695029' }}'
    var lngX = '{{ @$user->longitude?? '34.452212625718715' }}'
