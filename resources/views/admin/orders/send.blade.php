...
@section('content')
        ...
        <div class="row">
            <div class="col-8">
                ...
                <p style="margin-right: 25px;">{{__('admin.orders')}} / <small>{{__('admin.all_order_send_shipping')}} </small> </p>
            ...
            <div class="col-lg-12 ">
                <div class="card">
                    <div class="table-responsive">
                        <table id="dataTableOrderSend" class="table table-hover" style="text-align: center">
                            <thead>
                                <tr>
                                    <th scope="col">#id</th>
...
@section('js')
    <script>
        ...
        var table = $('#dataTableOrderSend').DataTable({
                                                         autoWidth: true,
                                                         responsive: true,
