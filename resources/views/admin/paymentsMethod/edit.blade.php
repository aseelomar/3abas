...
@section('content')
    ...
    <div class="row">
        <div class="col-8">
            ...
            <p style="margin-right: 25px;"> {{__('admin.paymentsMethod')}} / <small>{{__('admin.edit_paymentsMethod')}}  </small> </p>
        ...
        <div class="col-lg-12 ">
            ...
            <div class="card">
                ...
                <div class="card-body" style="margin-top: -40px">
                    <form class="form form-horizontal" method="POST" id="edit_pay" action="{{ route('paymentsMethod.update') }}">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="first-name-column" value="{{$payment->title_ar}}" class="form-control" placeholder="{{__('admin.title_ar')}}" name="title_ar">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="country-floating">{{__('admin.title_en')}}</label>
                                    <input type="text" value="{{$payment->title_en}}" class="form-control" name="title_en" placeholder="{{__('admin.title_en')}}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="country-floating">{{__('admin.value-payment')}}</label>
                                    <input type="text" value="{{$payment->value}}" class="form-control" name="value" placeholder="{{__('admin.value-payment')}}">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="country-floating">{{__('admin.rank')}}</label>
                                    <input type="number" value="{{$payment->rank}}" class="form-control" name="rank" placeholder="{{__('admin.rank')}}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="demo-inline-spacing">
                                    <div class="form-check form-check-inline ">
                                        <input class="form-check-input" type="radio" name="visible" id="inlineRadio3" value="1" {{  ($payment->visible == 1 ? ' checked' : '')}}>
                                        <label class="form-check-label" for="inlineRadio3">{{__('admin.active')}}</label>
                                    </div>
                                    <div class="form-check form-check-inline ">
                                        <input class="form-check-input" type="radio" name="visible" id="inlineRadio4" value="0" {{  ($payment->visible == 0 ? ' checked' : '')}}>
                            ...
                            <div class="col-12" style="margin-top: 25px">
                                <button type="submit" id="edit-payment-method" class="btn btn-primary me-1 waves-effect waves-float waves-light save">
