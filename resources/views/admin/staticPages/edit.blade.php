        ...
        <div class="col-lg-12 ">
            <div class="card">
                <div class="card-content">
                    ...
                    <form class="form container" method="POST" id="myFormStore" action="{{ route('page.store') }}" enctype="multipart/form-data">
                   ...
                   <div class="row">
                        <div class="form-label-group col-md-6">
                            <input type="text" id="" value="{{$page->page_title_ar}}" class="form-control"  placeholder="{{__('admin.arabic_name')}}" name="page_title_ar" >
                            {{-- <label for="first-name-column">{{__('admin.arabic_name')}} </label> --}}
                        </div>

                        <div class="form-label-group col-md-6">
                            <input type="text" id="" value="{{$page->page_title_en}}" class="form-control"  placeholder="{{__('admin.title_en')}}" name="page_title_en" >
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                           ...
                           <textarea  class="form-control" name="page_body_ar" id="editor" cols="30" rows="10"> {!! $page->page_body_ar !!}</textarea>
                         </div>

                        <div class="col-md-6">
                            <label for="">   {{__('admin.body_en')}}</label>
                           <textarea  class="form-control" name="page_body_en" id="editor1" cols="30" rows="10"> {!! $page->page_body_en !!} </textarea>
                         </div>
                    </div>
                                <br>
                        ...
                        <fieldset class="form-group">
                            ...
                            <div class=" custom-file mb-1">
                                <input type="file" name="image" class="custom-file-input"  value="{{asset('images/pages/'.$page->page_image)}}" id="inputGroupFile01">
                                <label class="custom-file-label form-control" id="helpInputTop">{{$page->page_image}}</label>
                            </div>
                        </fieldset>
                    </div>
                                {{-- <div class="form-group">
                                    <label>  Image </label>
                                    <input type="file" accept="image/*" class="form-control"  value="{{asset('images/pages/'.$page->page_image)}}" name="image">
                                </div> --}}
