...
@section('content')
    <div class="row">
        <div class="col-8">
            <p style="margin-right: 25px;"> {{ __('admin.add_new_client') }} </small> </p>
        </div>
    </div>
        ...
        <div class="col-lg-12 ">
            <div class="card">
                <div class="card-content">
                    ...
                    <div class="row">
                        <div class="col-9">
                            <h3 style="margin-right:60px;"> {{ __('admin.add_new_client') }}</h3>
                        </div>
                        <div class="col-md-2  col-sm-1">
                            <button type="button" onclick="window.location='{{ route('clients') }}'"
                                class=" btn btn-outline-danger" style="float: left;">{{ __('admin.back') }}</button>
                        </div>
                    </div>
                    <br>

                    {{-- <p style="margin-right: 25px;">@lang('Add A New Page')</p> --}}
                    <form class="form container" method="POST" id="myFormStore" action="{{ route('client.store') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="" class="form-control"
                                        placeholder="{{ __('admin.mobile') }}" name="mobile">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label"
                                        for="first-name-column">{{ __('admin.extra_mobile') }}</label>
                                    <input type="text" id="" class="form-control"
                                        placeholder="{{ __('admin.extra_mobile') }}" name="extra_mobile">
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="" class="form-control"
                                        placeholder="{{ __('admin.location') }}" name="location">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-1">
                                <label class="form-label" for="select2-multiple">{{ __('admin.country_id') }}</label>
