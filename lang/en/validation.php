...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'product_sale_price'=>'product sale priceع',
        'inventory'=>'inventory',
        'main_file'=>'main image ',
        'sub_file'=>'sub image',
        'productSpecificat'=>'product Specification',
        'group_a.*.color_id'=>'color',
        'group_a.*.size'=>'size',
        'group_a.*.count'=>'count',
        ...
        'stamp'=>'Stamp',
        'productSpecifications'=>'Has Specifications',
        'search_status'=>'Search Status',
        'massage_reject'=>'Add massage reject',
        'massageReject'=>'Massage Reject',
    ],
