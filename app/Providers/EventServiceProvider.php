...
use App\Listeners\SendContactUsNotification;
use App\Listeners\SendRejectMassegeOrderNotifiy;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        ContactUsEvent::class=>[
            SendContactUsNotification::class,
        ],
        RejectOrderEvent::class=>[
                SendRejectMassegeOrderNotifiy::class,
        ],
