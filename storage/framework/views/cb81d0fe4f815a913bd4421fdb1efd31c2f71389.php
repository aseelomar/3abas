<section class="hero">
    <img src="<?php echo e(asset('site/images/hero-bg.webp')); ?>" alt="img" class="hero-bg"/>
    <div class="second-header">
        <div class="container-content">
            <div class="content-links">
                ...
                <ul class="links">
                    <li class="active-link"><a href="#"><?php echo app('translator')->get('site.home'); ?></a></li>
        ...
        <div class="container-content">
            <ul>
                <li class="yellow-color">
                    <span></span>
                    <p><?php echo app('translator')->get('site.quick_receipt'); ?></p>
                </li>
                <li>
                    <span></span>
                    <p><?php echo app('translator')->get('site.trusted_products'); ?></p>
                </li>
                <li>
                    <span></span>
                    <p><?php echo app('translator')->get('site.lower_prices'); ?></p>
                </li>
            </ul>
        </div>
    </div>
...
<?php /**PATH /mnt/c/Users/jit/Desktop/addass/3abas/resources/views/site/home/include/subHeader.blade.php ENDPATH**/ ?>