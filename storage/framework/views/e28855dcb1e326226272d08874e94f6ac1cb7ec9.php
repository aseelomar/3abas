<?php $__env->startSection('js'); ?>
    <script src="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/11.6.13/sweetalert2.min.js')); ?>"></script>
    ...
    <script>
        function getval(sel) {
            ...
            $.ajax({
                       url: '<?php echo e(route('site.getAllDetail')); ?>',
                       dataType: 'html',
                       method: 'GET',
                       data: {
        ...
        $('.add-to-cart').click(function (e) {
            ...
            //console.log(form[0])
            var url = "<?php echo e(route('site.cart.add')); ?>";
...
<?php /**PATH /mnt/c/Users/jit/Desktop/addass/3abas/resources/views/site/pages/product/include/addToCart.blade.php ENDPATH**/ ?>