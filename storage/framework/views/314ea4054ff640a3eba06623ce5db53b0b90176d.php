...
<head>
    ...
    <title><?php echo app('translator')->get('site.store_name'); ?>-<?php echo $__env->yieldContent('title'); ?></title>
    <!--FONT LINKS-->
    ...
    />
    <!--MAIN STYLE FILE-->
    <link rel="stylesheet" href="<?php echo e(asset('site/css/sweetalert2.min.css')); ?>">
...
<section class="header-pages">
                ...
                <li>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="34.178" height="27" viewBox="0 0 34.178 27">
                        <g id="Icon_feather-mail" data-name="Icon feather-mail" transform="translate(-0.911 -4.5)">
                            <path id="Path_9" data-name="Path 9" d="M6,6H30a3.009,3.009,0,0,1,3,3V27a3.009,3.009,0,0,1-3,3H6a3.009,3.009,0,0,1-3-3V9A3.009,3.009,0,0,1,6,6Z" fill="none" stroke="#f0f72b" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/>
                            <path id="Path_10" data-name="Path 10" d="M33,9,18,19.5,3,9" fill="none" stroke="#f0f72b" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"/>
                        </g>
                    </svg>
                </li>
            </ul>
    ...
    <div class="second-header">
        <div class="container-content">
            <div class="content-links">
                <a href="#" class="logo">
                    <span><?php echo app('translator')->get('site.logo'); ?></span>
                </a>
                <ul class="links">
                    <li class="active-link"><a href="<?php echo e(route('site.index')); ?>"><?php echo app('translator')->get('site.home'); ?></a></li>
                    <li><a  target="_self" href="<?php echo e(route('site.product.offerProduct')); ?>"><?php echo app('translator')->get('site.offers'); ?></a></li>
                    <li><a target="_self"  href="<?php echo e(route('site.product.favProduct')); ?>"><?php echo app('translator')->get('site.favorite'); ?></a></li>
                    <li><a  target="_self" href="<?php echo e(route('site.staticPage',\App\Models\StaticPages::STATIC_PAGE_CALL_US)); ?>"><?php echo app('translator')->get('site.contact_us'); ?></a></li>
                    <li><a target="_self" href="<?php echo e(route('contactUs')); ?>"><?php echo app('translator')->get('site.support'); ?></a></li>

                    <li><a target="_self"  href="<?php echo e(route('site.staticPage',\App\Models\StaticPages::STATIC_PAGE_TERMS_SERVICE)); ?>"><?php echo app('translator')->get('site.terms_service'); ?></a></li>
                    <li><a target="_self" href="<?php echo e(route('site.staticPage',\App\Models\StaticPages::STATIC_PAGE_WHO_ARE_WE)); ?>"><?php echo app('translator')->get('site.who_are_we'); ?></a></li>
                </ul>
                <div class="action-header">
                    ...
                    <form  action="<?php echo e(route('site.product.searchProduct')); ?>" method="POST" id="form-search">
                        <?php echo csrf_field(); ?>
                    <ul class="search-results custom-position-and-width" style="height: auto">
                        ...
                        <li>
                            <a  id="search-button"><?php echo e('ابحث'); ?></a>
                        </li>
                        </li>
                    ...
                    <a  target="_self" href="<?php echo e(route('site.cart.show')); ?>" class="shopping-bag custom-link">
                    ...
                    <button   <?php if(Auth::user() == null): ?> onclick="window.location='<?php echo e(route('login')); ?>'"<?php endif; ?> type="button" class="show-user-menu custom-link">
                    ...
                    <ul class="user-menu">
                        <?php if(Auth::user()): ?>
                        <li><a target="_self" href="<?php echo e(route('profile')); ?>"><?php echo app('translator')->get('site.profile'); ?></a></li>
                        <li><a target="_self" href="#"><?php echo app('translator')->get('site.settings'); ?></a></li>
    ...
    <div class="breadcrumb">
        <div class="container-content">
            <div class="content">
                <h1 class="page-title-breadcrumb"><?php echo $__env->yieldContent('subTitle'); ?></h1>
                <ul class="items">
                    <li>
                        <a target="_self"  href="<?php echo e(route('site.index')); ?>"><?php echo app('translator')->get('site.home'); ?></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <span><?php echo $__env->yieldContent('sub_Title'); ?></span>
                    </li>
                </ul>
            </div>
        </div>
...
<script src="<?php echo e(asset('site/js/order-request.js')); ?>"></script>
...
<?php /**PATH /mnt/c/Users/jit/Desktop/addass/3abas/resources/views/site/layout/site.blade.php ENDPATH**/ ?>