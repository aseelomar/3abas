...
<?php $__env->startSection('title',__('site.notification')); ?>
<?php $__env->startSection('subTitle',__('site.notification')); ?>
<?php $__env->startSection('sub_Title',__('site.notification')); ?>
<?php $__env->startSection('content'); ?>
    ...
    <main>
                ...
                <div class="profile-layout">
                    ...
                    <div class="main-wrapper">
                        <div class="title-profile">
                            ...
                            <h3><?php echo e(__('site.notification')); ?></h3>
                        </div>
                        <div class="order-boxes" >
                          ...
                          <?php $__currentLoopData = @$notification; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="order-box" <?php if( @$item->seen ==0): ?> style="background: aliceblue;" <?php endif; ?>>

                                    <div class="header-box row col-12 ">

                                        <span class="order-num"> # <?php echo e($loop->iteration); ?></span>
                                        <span class="order-num">تم اراسلها من قبل:<?php echo e(@$item->userForm->name); ?></span>
                                        <?php if(isset($item->contactUs)): ?>
                                            <span  hidden> <?php echo e(@$text =substr_replace(@$item->contactUs->message, "...", 20)); ?></span>
                                            <span class="order-num">الرسالة:<?php echo $text; ?></span>
                                        <?php elseif(isset($item->order)): ?>
                                          <span hidden><?php echo e(@$text =substr_replace(@$item->order->note, "...", 20)); ?></span>
                                            <span class="order-num">الرسالة:<?php echo $text; ?></span>
                                        <?php endif; ?>
                                        <span class="order-num"><?php echo e(\Carbon\Carbon::parse(@$item->created_at)->diffForHumans()); ?></span>
                                        <button type="button" class="btn btn-outline-success waves-effect showMassage waves-light" data-toggle="modal" data-value=" <?php echo e(@$item->id); ?>" data-target="#massageView<?php echo e(@$item->id); ?>">
                                            عرض التفاصيل
                                        </button>
                                 </div>

                                </div>
                                <div class="modal show" id="massageView<?php echo e(@$item->id); ?>"  tabindex="-1" role="dialog">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <input hidden value=" <?php echo e(@$item->seen); ?>" id="valueSeen">
                                                <p><?php if(isset($item->contactUs)): ?>
                                                        <span class="order-num">الرسالة:</span>
                                                        <?php echo @$item->contactUs->message; ?>

                                                    <?php elseif(isset($item->order)): ?>
                                                        <span class="order-num">الرسالة:</span>
                                                        <?php echo $item->order->note; ?>
        ...
        <a id="redirict" href="<?php echo e(route('profile.notification')); ?>" target="_blank" hidden></a>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.showMassage', function () {
            ...
            $.ajax({
                       url : '<?php echo e(route('profile.editNotification')); ?>',
                       type: 'POST',
                       data: {
...
<?php echo $__env->make('site.layout.site', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/Users/jit/Desktop/addass/3abas/resources/views/site/pages/profile/notification.blade.php ENDPATH**/ ?>