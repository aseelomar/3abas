...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('site/contact/fonts/icomoon/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('site/contact/css/bootstrap.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('site/contact/css/style.css')); ?>">
    ...
    <link rel="stylesheet" type="text/css"
        href="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/11.6.13/sweetalert2.min.css')); ?>">
            ...
            <div class="container-content">
                <div class="content-links">
                    ...
                    <div class="action-header">
                        ...
                        <li><a  target="_self" href="#"><?php echo app('translator')->get('site.sign_out'); ?></a></li>
                        <?php endif; ?>
                        </ul>
                    </div>
                </div>
            ...
            <div class="content-footer">
                <div class="right-section">
                    ...
                    <ul class="links">
                        ...
                        <li><a target="_self" href="#"><?php echo app('translator')->get('site.login'); ?></a></li>
                    </ul>
                </div>
                <ul class="social-media-buttons">
                    <li>
...
<?php /**PATH /mnt/c/Users/jit/Desktop/addass/3abas/resources/views/site/layout/site1.blade.php ENDPATH**/ ?>