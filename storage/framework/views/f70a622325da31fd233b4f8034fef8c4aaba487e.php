...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/vendors/css/charts/apexcharts.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/vendors/css/extensions/tether-theme-arrows.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/vendors/css/extensions/tether.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/vendors/css/extensions/shepherd-theme-default.css')); ?>">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css-rtl/pages/dashboard-analytics.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css-rtl/pages/card-analytics.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css-rtl/plugins/tour/tour.css')); ?>">
    <!-- END: Page CSS-->

    <!-- BEGIN: Custom CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css-rtl/custom-rtl.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/assets/css/style-rtl.css')); ?>">
...
<script src="<?php echo e(url('app-assets/vendors/js/extensions/tether.min.js')); ?>"></script>
<!-- END: Page Vendor JS-->
...
<!-- BEGIN: Page JS-->
<script src="<?php echo e(url('app-assets/js/scripts/pages/dashboard-analytics.js')); ?>"></script>
<script src="<?php echo e(url('app-assets/js/scripts/forms/select/form-select2.js')); ?>"></script>
<script src="<?php echo e(url('app-assets/js/forms/select/select2.full.min.js')); ?>"></script>
...
<?php /**PATH /mnt/c/Users/jit/Desktop/addass/3abas/resources/views/layouts/master.blade.php ENDPATH**/ ?>