<section class="what-visitors-see section-margin">
    <div class="container-content">
        <div class="section-header">
            <h2><?php echo app('translator')->get('site.visitor_see'); ?> </h2>
            <a target="_self" href="<?php echo e(route('site.product.visitorSee')); ?>">
        ...
        <div class="swiper" id="what_visitors_see_swiper">
            <div class="swiper-wrapper">
                <?php $__currentLoopData = @$visitorSee; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="details">
                            <div class="title-like">
                                ...
                                <button type="button" class="like-button <?php if(Auth::user() && isset(Auth::user()->fav_product) && in_array($item->id , Auth::user()->fav_product)): ?>
                                    active
                                <?php endif; ?>"productId='<?php echo e(@$item->id); ?>'>
...
<?php /**PATH /mnt/c/Users/jit/Desktop/addass/3abas/resources/views/site/home/include/visitorsSee.blade.php ENDPATH**/ ?>