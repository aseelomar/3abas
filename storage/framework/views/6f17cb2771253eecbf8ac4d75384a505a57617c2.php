<section class="bestseller-this-week section-margin">
    <div class="container-content">
        <div class="section-header">
            <h2> <?php echo app('translator')->get('site.best_seller_this_week'); ?>ً</h2>
            <a target="_self" href="<?php echo e(route('site.product.bestSellerThisWeek')); ?>">
                <span>الكل</span>
        ...
        <div class="swiper" id="bestseller_this_week_swiper">
            <div class="swiper-wrapper">
                <?php $__currentLoopData = @$bestSellerThisWeek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="swiper-slide">
                    <div class="large-product-box">
                        <div class="img-box">
                            <a target="_self" href="<?php echo e(route('site.showProduct',@$item->product_id)); ?>">
                            <img src="<?php echo e(asset('images/products/'.@$item->product_id .'/'.@$item->product->mainPhoto->image)); ?>" alt="img"/>
                            </a>
                        </div>
                        <div class="details">
                            <div class="title-like">
                                <a  target="_self" href="<?php echo e(route('site.showProduct',@$item->product_id)); ?>"><?php echo e(@$item->product->name); ?></a>
                                <button type="button" class="like-button <?php if(Auth::user() && isset(Auth::user()->fav_product) && in_array($item->id , Auth::user()->fav_product)): ?>
                                    active
                                <?php endif; ?>"productId='<?php echo e($item->product_id); ?>'>
                            ...
                            <div class="price-rate">
                                <h3><?php echo e(@$item->product->product_sale_price); ?><span style="font-size: x-small;font-weight: 500;">شيكل</span></h3>
                                <div class="rate-text">
...
</section><!--bestseller-this-week-->
<?php /**PATH /mnt/c/Users/jit/Desktop/addass/3abas/resources/views/site/home/include/bestSellerThisWeek.blade.php ENDPATH**/ ?>